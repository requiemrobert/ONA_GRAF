...
$(function(){
    ...
    $("#registrar_proveedor").on('click', function(event){

        event.preventDefault();
        var $form = $("#registrar-proveedor");
...
function registrarProveedor(dataJson){

    $login = $.ajax({
                      type: "POST",
                      url: baseURL + "registrar_proveedor",
                      data: dataJson,
